...
const Header = () => {
  ...
  const headerLinks = [
    ...
    },
    {
      ...
      dropdown: true,
      items: [
        { label: "Announcements", to: "/community/announcement" },
        { label: "New Posts", to: "/community/new-posts" },
        { label: "Your Threads", to: "/community/threads" },
        { label: "Members", to: "/community/members" },
        { label: "Create Request", to: "/community/request" },
        { label: "Watched threads", to: "/community/watched threads" },
        { label: "Watched threads", to: "/community/watched threads" },
      ],
    },
